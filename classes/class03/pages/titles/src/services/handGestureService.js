// import { gestureStrings, knowGestures } from "../utils/util.js";
export default class HandGestureService {
  ...
  constructor({ fingerpose, handPoseDetection, gestureStrings, knowGestures }) {
  ...
  async *detectGesture(predictions) {
    for (const hands of predictions) {
      ...
      console.log("detected ", result.name, this.#gestureString[result.name], x, y);
    }
  }
